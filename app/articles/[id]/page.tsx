    ...
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", fontFamily: "var(--font-sans, system-ui)", background: "#f8fafc" }}>
      ...
      <main style={{ flex: 1, maxWidth: 780, margin: "0 auto", width: "100%", padding: "32px 16px 64px" }}>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <p style={{ margin: 0, fontSize: 16, lineHeight: 1.7, color: "#475569", borderLeft: "3px solid #e84d0e", paddingLeft: 16 }}>
            {contenu.intro}
          </p>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
          {contenu.sections.map((s, i) => (
            <section key={i}>
              <h2 style={{ fontSize: 18, fontWeight: 800, color: "#0f172a", margin: "0 0 12px", paddingBottom: 8, borderBottom: "2px solid #e84d0e", display: "inline-block" }}>
                {s.titre}
              </h2>
        ...
        {article.dossier && (
          <div style={{ marginTop: 40 }}>
            <Link href={`/bruz-en-action/dossiers/${article.dossier}`}
              style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 14, fontWeight: 600, color: "#e84d0e", textDecoration: "none" }}>
