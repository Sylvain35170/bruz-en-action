      ...
      <main style={{ flex: 1 }}>
        <div style={{ maxWidth: 860, margin: "0 auto", padding: "48px 24px" }}>
          ...
          <section style={{ marginBottom: 52 }}>
            ...
            <div style={{ background: "#fff8f5", border: "1px solid #fed7aa", borderLeft: "4px solid #E8A040", borderRadius: 12, padding: "24px 28px", marginBottom: 24 }}>
              ...
              <p style={{ margin: 0, fontSize: 14, color: "#334155", lineHeight: 1.75 }}>
                ...
                la{" "}
                <a href="https://www.cada.fr/" target="_blank" rel="noopener noreferrer" style={{ color: "#E8A040", fontWeight: 600 }}>CADA (Commission d'Accès aux Documents Administratifs)</a>{" "}
              ...
              {[
                ...
                <div key={etape} style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 12, padding: "16px 18px" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
                    <span style={{ width: 28, height: 28, borderRadius: "50%", background: "#0E2F62", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, fontWeight: 800, flexShrink: 0 }}>{etape}</span>
