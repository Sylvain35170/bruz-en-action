      ...
      <main style={{ flex: 1 }}>
        <div style={{ maxWidth: 1120, margin: "0 auto", padding: "48px 24px" }}>
          ...
          <p style={{ marginTop: 40, fontSize: 12, color: "#94a3b8", textAlign: "center" }}>
            Les dossiers marqués <strong style={{ color: "var(--brand-accent, #E8A040)" }}>● Actif</strong> remontent automatiquement en tête selon les dernières actualités collectées.
          </p>
        </div>
      </main>
