    ...
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "#f8fafc" }}>
      ...
      <main style={{ flex: 1, maxWidth: 1120, margin: "0 auto", padding: "48px 24px", width: "100%" }}>
        ...
        <section style={{ marginBottom: 48 }}>
          <h2 style={{ fontSize: 17, fontWeight: 800, color: "#0f172a", margin: "0 0 20px", paddingBottom: 10, borderBottom: "2px solid #e84d0e", display: "inline-block" }}>
            Maire &amp; adjoints
          </h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 16 }}>
            {elus.filter(e => e.type === "maire" || e.type === "adjoint").map(elu => (
              <div key={elu.id} style={{
                ...
                borderLeft: elu.type === "maire" ? "4px solid #e84d0e" : "4px solid #3b82f6",
              }}>
