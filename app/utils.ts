...
export const THEMES_AGENDA: { id: string; label: string; couleur: string; tags: string[] }[] = [
  { id: "culture",     label: "Culture & spectacles",    couleur: "#7c3aed",
    tags: ["Théâtre", "Concert", "Spectacle", "Exposition", "Culture", "Mortel !"] },
  ...
  { id: "solidarite",  label: "Solidarité & entraide",   couleur: "#059669",
    tags: ["Solidarité", "Semaine Bleue", "L'Escale"] },
  { id: "famille",     label: "Famille & jeunesse",      couleur: "#c026d3",
    tags: ["Famille", "Jeux"] },
  { id: "services",    label: "Services & permanences",  couleur: "#475569",
    tags: ["Permanence", "Mairie"] },
