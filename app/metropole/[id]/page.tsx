      ...
      <main style={{ flex: 1 }}>
        <div style={{ maxWidth: 860, margin: "0 auto", padding: "40px 24px" }}>
          ...
          <section style={{ marginBottom: 40 }}>
            <h2 style={{ fontSize: 18, fontWeight: 800, margin: "0 0 16px", color: "#0f172a", paddingBottom: 8, borderBottom: "2px solid #E8A040", display: "inline-block" }}>Ce qu'on sait</h2>
          ...
          {/* Qui décide */}
          <section style={{ marginBottom: 40 }}>
            <h2 style={{ fontSize: 18, fontWeight: 800, margin: "0 0 16px", color: "#0f172a", paddingBottom: 8, borderBottom: "2px solid #E8A040", display: "inline-block" }}>Qui décide ?</h2>
          ...
          {decisions.length > 0 && (
            <section style={{ marginBottom: 40 }}>
              <h2 style={{ fontSize: 18, fontWeight: 800, margin: "0 0 16px", color: "#0f172a", paddingBottom: 8, borderBottom: "2px solid #E8A040", display: "inline-block" }}>Décisions clés</h2>
          ...
          {/* Ce qu'on suit */}
          <section style={{ marginBottom: 40 }}>
            <h2 style={{ fontSize: 18, fontWeight: 800, margin: "0 0 16px", color: "#0f172a", paddingBottom: 8, borderBottom: "2px solid #E8A040", display: "inline-block" }}>Ce qu'on surveille</h2>
          ...
          {actus.length > 0 && (
            <section style={{ marginBottom: 40 }}>
              <h2 style={{ fontSize: 18, fontWeight: 800, margin: "0 0 16px", color: "#0f172a", paddingBottom: 8, borderBottom: "2px solid #E8A040", display: "inline-block" }}>Dernières actus</h2>
          ...
          {dossier.sources.length > 0 && (
            <section style={{ marginBottom: 40 }}>
              <h2 style={{ fontSize: 18, fontWeight: 800, margin: "0 0 16px", color: "#0f172a", paddingBottom: 8, borderBottom: "2px solid #E8A040", display: "inline-block" }}>Sources</h2>
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <div style={{ background: "#fff8f5", border: "1px solid #fed7aa", borderLeft: "4px solid #E8A040", borderRadius: 12, padding: "20px 24px" }}>
            <div style={{ fontSize: 13, fontWeight: 700, color: "#E8A040", marginBottom: 8 }}>Vous avez des informations sur ce dossier ?</div>
